...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="dsGruposAlumnos" runat="server" ConnectionString="<%$ ConnectionStrings:UniversidadConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [ID], [Estatus], [GrupoID], [AlumnoID] FROM [GruposAlumnos] ORDER BY [GrupoID]" ConflictDetection="CompareAllValues" DeleteCommand="DELETE FROM [GruposAlumnos] WHERE [ID] = @original_ID AND [Estatus] = @original_Estatus AND [GrupoID] = @original_GrupoID AND [AlumnoID] = @original_AlumnoID" InsertCommand="INSERT INTO [GruposAlumnos] ([Estatus], [GrupoID], [AlumnoID]) VALUES (@Estatus, @GrupoID, @AlumnoID)" UpdateCommand="UPDATE [GruposAlumnos] SET [Estatus] = @Estatus, [GrupoID] = @GrupoID, [AlumnoID] = @AlumnoID WHERE [ID] = @original_ID AND [Estatus] = @original_Estatus AND [GrupoID] = @original_GrupoID AND [AlumnoID] = @original_AlumnoID">
        <DeleteParameters>
    ...
    <asp:SqlDataSource ID="dsAlumnos" runat="server" ConnectionString="<%$ ConnectionStrings:UniversidadConnectionString %>"
        SelectCommand="SELECT [ID], [Nombre] FROM [Alumnos] ORDER BY [Nombre]"></asp:SqlDataSource>
