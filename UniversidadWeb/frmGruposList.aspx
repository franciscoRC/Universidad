<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/UniMasterOne.Master" CodeBehind="frmGruposList.aspx.vb" Inherits="UniversidadWeb.frmGruposList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <div class="row">
		    <div class="col-md-12">
                ...
                <div class="tabla-adaptable">
                    ...
                    <dx:ASPxGridView CssClass="tabla-adaptable" ID="gvwGrupos" runat="server"  
                        AutoGenerateColumns="False" DataSourceID="dsGrupos" KeyFieldName="ID"
                        OnRowUpdating="gvwGrupos_RowUpdating" OnRowInserting="gvwGrupos_RowInserting">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn FieldName="CicloID" Caption="Ciclo" VisibleIndex="5">
                                <PropertiesComboBox DataSourceID="dsCiclos" TextField="Nombre" ValueField="ID">
                                </PropertiesComboBox>
                            ...
                            <%--<dx:GridViewDataTextColumn FieldName="CicloID" Caption="Carrera" VisibleIndex="7" Visible="False">
                            </dx:GridViewDataTextColumn>--%>
                        </Columns>                    
                        <Styles>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-4">
                                                             ...
                                                             <div class="form-group col-md-4" style="position:inherit;">
                                                                ...
                                                                <dx:ASPxLabel ID="lblCiclo" for="cmbCiclo" runat="server" Text="Ciclo:"></dx:ASPxLabel>
                                                                ...
                                                                <dx:ASPxComboBox ID="cmbCiclo" runat="server" DataSourceID="dsCiclos" TextField="Nombre"
                                                                    ValueField="ID" ValueType="System.Int32" Width="100%" Value='<%# Bind("CicloID")%>'>
                                                                </dx:ASPxComboBox>
                                                            </div>
                                                            <div class="form-group col-md-4" style="position:inherit;">

                                                                <dx:ASPxLabel ID="lblSemestre" for="cmbSemestre" runat="server" Text="Semestre:"></dx:ASPxLabel>
    ...
    <asp:SqlDataSource ID="dsGrupos" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:UniversidadConnectionString %>" DeleteCommand="DELETE FROM [Grupos] WHERE [ID] = @original_ID AND [Nombre] = @original_Nombre AND [CicloID] = @original_CicloID AND [SemestreID] = @original_SemestreID" InsertCommand="INSERT INTO [Grupos] ([Nombre], [CicloID], [SemestreID]) VALUES (@Nombre, @CicloID, @SemestreID)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [ID], [Nombre], [CicloID], [SemestreID] FROM [Grupos] ORDER BY [Nombre] DESC" UpdateCommand="UPDATE [Grupos] SET [Nombre] = @Nombre, [CicloID] = @CicloID, [SemestreID] = @SemestreID WHERE [ID] = @original_ID AND [Nombre] = @original_Nombre AND [CicloID] = @original_CicloID AND [SemestreID] = @original_SemestreID">
        <DeleteParameters>
            <asp:Parameter Name="original_ID" Type="Int32" />
            <asp:Parameter Name="original_Nombre" Type="String" />
            <asp:Parameter Name="original_CicloID" Type="Int32" />
    ...
    <asp:SqlDataSource ID="dsCiclos" runat="server" ConnectionString="<%$ ConnectionStrings:UniversidadConnectionString %>" 
        OldValuesParameterFormatString="original_{0}"
        SelectCommand="SELECT [ID], [Nombre] FROM [Ciclos] ORDER BY [Nombre]">
    </asp:SqlDataSource>
