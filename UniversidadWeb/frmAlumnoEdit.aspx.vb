...
#Region " asignar y DESPLEGAR DATOS en los controles"
    ...
    Private Function BuscaElementoEnBD(ByVal mID As Int32) As Alumno
        ...
        Using mDbContext As New UniversidadContext.UniversidContext("name=UniversidadConnectionString")
            ...
            moCatalogo = (From d In mDbContext.Alumnos
...
#Region "Botones de acción, GRABAR - CANCELAR"
    ...
    Protected Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        If GrabarDatos() Then
            ...
            '
            Response.Redirect("frmAlumnoList.aspx")
    ...
    Private Function ValidarCamposOblogatorios() As Boolean
        ...
        If txtApellidoPaterno.Text = "" Then
            lblErroresValidacion.Text = "ERROR!... El campo Apellido Paterno es obligatorio !"
            lblErroresValidacion.Visible = True
            Return False
        End If
        If txtApellidoMaterno.Text = "" Then
            lblErroresValidacion.Text = "ERROR!... El campo Apellido Materno es obligatorio !"
            lblErroresValidacion.Visible = True
            Return False
        End If
    ...
    Private Function GrabarDatos() As Boolean
        ...
        Using mDbContext As New UniversidadContext.UniversidContext("name=UniversidadConnectionString")
            ...
            With moCatalogo
                ...
                .Estatus = chkActivo.Value
                .FechaNacim = dtpFechaNac.Value
                .Domicilio1 = txtDomicilio1.Text
                .Domicilio2 = txtDomicilio2.Text
                .Domicilio3 = txtDomicilio3.Text
